process LOBE_ATLAS {
    ...
    scil_volume_reslice_to_reference.py wmparc.nii.gz orig.nii.gz wmparc.nii.gz --interpolation nearest -f
    ...
    scil_volume_reslice_to_reference.py atlas_lobes_v5.nii.gz orig.nii.gz atlas_lobes_v5.nii.gz --interpolation nearest -f
    scil_volume_reslice_to_reference.py atlas_lobes_v5_dilate.nii.gz orig.nii.gz atlas_lobes_v5_dilate.nii.gz --interpolation nearest -f
